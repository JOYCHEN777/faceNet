...
def fit_ont_epoch(model, loss, epoch, epoch_size, gen, val_epoch_size, gen_val, Epoch, test_loader, cuda):
    ...
    loss_history.append_loss(np.mean(accuracy), (total_triple_loss + total_CE_loss) / (epoch_size + 1),
...
if __name__ == "__main__":
    ...
    # --------------------------------------#
    #   choice the input size 输入图片大小：112，16，96
    #   可选 112 160 96
    # --------------------------------------#
    input_shape = [112, 112, 3]
    # input_shape = [96,96, 3]
    # --------------------------------------#
    #   choice the backbone ：mobilenet/facenet主干特征提取网络的选择
    #   mobilenet
    #   inception_resnetv1
    # --------------------------------------#
    backbone = "mobilenet"
    ...
    # model_path ="logs/Epoch50-Total_Loss0.2616.pth-Val_Loss1.1785.pth"
    # 加快模型训练的效率
    ...
    # -------------------------------------------------------#
    #   0.05 for testing，0.95 for training
    # -------------------------------------------------------#
    val_split = 0.05
